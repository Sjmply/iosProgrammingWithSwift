...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let department3Id = DepartmentEntity.shared.insert(name: "Sales Department",
                                                           address: "An example address 3", city: "Pennsylvania", zipCode: 3333)
        let department4Id = DepartmentEntity.shared.insert(name: "Investor News Department", address: "An example address 4", city: "Florida", zipCode: 4444)
        let department5Id = DepartmentEntity.shared.insert(name: "Department of Education and Researching ", address: "An example address 5", city: "Indiana", zipCode: 5555)
